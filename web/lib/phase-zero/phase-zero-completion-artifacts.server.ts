...
const artifactPaths = {
  ...
  evidenceCoverageControlCenter: "data/phase-zero/evidence_coverage_control_center.json",
  secondVerifierDashboard: "data/phase-zero/second-verifier-execution-package/verifier_dashboard.json"
