# Hair Color Recapture Report

Status: **OPEN_RECAPTURE_REQUIRED**

## HAIR-COLOR-RECAPTURE-001

- Priority: P0
- Linked capture requests: GFM-CAP-007, GFM-CAP-009
- Exact menu path: Create Player > Player > Appearance > Hair, then the visible hair-color control only if directly shown
