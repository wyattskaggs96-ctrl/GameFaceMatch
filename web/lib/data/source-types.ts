...
export const dataSourceTypeLabels: Record<DataSourceType, string> = {
  ...
  betaResearch: "Private beta research data",
...
export const dataSourceTypeDescriptions: Record<DataSourceType, string> = {
  ...
  betaResearch: "Non-production data for the controlled ten-user research beta; may support clearly labeled beta recommendations but cannot satisfy production catalog gates.",
