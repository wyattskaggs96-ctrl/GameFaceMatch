...
const stages = [
  ...
  {
    name: "Phase 0 production verification queue check",
    command: "node",
    args: ["scripts/cf27-production-verification-queue.mjs", "--check"],
    cwd: repositoryRoot
  },
  {
    name: "Phase 0 evidence recapture package check",
    command: "node",
    args: ["scripts/cf27-evidence-recapture-package.mjs", "--check"],
    cwd: repositoryRoot
  },
  {
  ...
  {
    name: "Phase 0 CF27 owner capture closure package check",
    command: "node",
    args: ["scripts/cf27-capture-closure-package.mjs", "--check"],
    cwd: repositoryRoot
  },
  {
