# CF27 Owner Minimum Recording Guide
...
- Eye color: recovered frame listed in `data/phase-zero/cf27_frame_reextractions.json`; no new recording is needed solely for this front-view audit gap.
- Eye shape: recovered frame listed in `data/phase-zero/cf27_frame_reextractions.json`; no new recording is needed solely for this front-view audit gap.
- Facial-hair colors: recovered frame listed in `data/phase-zero/cf27_frame_reextractions.json`; no new recording is needed solely for this front-view audit gap.
- Hair colors: recovered frame listed in `data/phase-zero/cf27_frame_reextractions.json`; no new recording is needed solely for this front-view audit gap.
- Mouth shape: recovered frame listed in `data/phase-zero/cf27_frame_reextractions.json`; no new recording is needed solely for this front-view audit gap.
- Skin details: recovered frame listed in `data/phase-zero/cf27_frame_reextractions.json`; no new recording is needed solely for this front-view audit gap.
- Skin tone: recovered frame listed in `data/phase-zero/cf27_frame_reextractions.json`; no new recording is needed solely for this front-view audit gap.
...
- Category or range: environment/version/patch/platform proof
...
- Lock these settings: Keep Road to Glory Custom Create Player environment and unrelated appearance settings unchanged.
- Show first/final selector values: no
- Required view(s): ENVIRONMENT_SCREEN
- Hold time: Hold 3 seconds on the menu label/index and 3 seconds after each requested angle settles.
- Label/index visibility: Visible game title/version/patch/platform text; avoid private account data.
- One continuous clip acceptable: yes, if every listed evidence item remains readable and no unrelated setting is changed
- Existing evidence supplemented: CF27_XBOX_SOURCE_2026_08_02_001; CF27_XBOX_SOURCE_2026_08_02_002; CF27_XBOX_SOURCE_2026_08_02_003
...
- Category or range: first value through final value plus wrap/no-wrap proof
- Starting state: Start from the supported Road to Glory Custom Create Player path with the current canonical research slate.
...
- Category or range: CF27_XBOXUNKNOWN_RTG_CHIN_SQUARE
- Starting state: Start from the supported Road to Glory Custom Create Player path with the current canonical research slate.
- Lock these settings: Lock the canonical face slate: same head/skin/hair/facial-hair/body setup, no setting changes except the selected control, stable lighting and zoom.
- Show first/final selector values: yes
- Required view(s): FRONT; LEFT_PROFILE; RIGHT_PROFILE
- Hold time: Hold 3 seconds on the menu label/index and 3 seconds after each requested angle settles.
- Label/index visibility: Native menu label, selected value, and native index/order must remain readable.
- One continuous clip acceptable: yes, if every listed evidence item remains readable and no unrelated setting is changed
...
- Category or range: CF27_XBOXUNKNOWN_RTG_JAWSHAPE_SQUARE
- Starting state: Start from the supported Road to Glory Custom Create Player path with the current canonical research slate.
- Lock these settings: Lock the canonical face slate: same head/skin/hair/facial-hair/body setup, no setting changes except the selected control, stable lighting and zoom.
- Show first/final selector values: yes
- Required view(s): FRONT; LEFT_PROFILE; RIGHT_PROFILE
...
- Menu path: Create Player > Player > Appearance > Head & Skin > Nose
- Category or range: CF27_XBOXUNKNOWN_RTG_NOSE_001; CF27_XBOXUNKNOWN_RTG_NOSE_002; CF27_XBOXUNKNOWN_RTG_NOSE_003; CF27_XBOXUNKNOWN_RTG_NOSE_004; CF27_XBOXUNKNOWN_RTG_NOSE_005; CF27_XBOXUNKNOWN_RTG_NOSE_006; CF27_XBOXUNKNOWN_RTG_NOSE_007
- Starting state: Start from the supported Road to Glory Custom Create Player path with the current canonical research slate.
- Lock these settings: Lock the canonical face slate: same head/skin/hair/facial-hair/body setup, no setting changes except the selected control, stable lighting and zoom.
- Show first/final selector values: yes
- Required view(s): FRONT; LEFT_PROFILE; RIGHT_PROFILE
...
- Label/index visibility: Native menu label, selected value, and native index/order must remain readable.
- One continuous clip acceptable: yes, if every listed evidence item remains readable and no unrelated setting is changed
- Existing evidence supplemented: phase0-video-004
- Blocker cleared: Existing footage was inspected and cannot satisfy this production requirement; frame extraction and verifier review cannot create the missing fact/view/boundary.
...
- Category or range: REQ-DEPENDENCY-TESTS
- Starting state: Start from the supported Road to Glory Custom Create Player path with the current canonical research slate.
- Lock these settings: Keep Road to Glory Custom Create Player environment and unrelated appearance settings unchanged.
- Show first/final selector values: no
- Required view(s): DEPENDENCY_TEST
- Hold time: Hold 3 seconds on the menu label/index and 3 seconds after each requested angle settles.
- Label/index visibility: Native menu label, selected value, and native index/order must remain readable.
- One continuous clip acceptable: yes, if every listed evidence item remains readable and no unrelated setting is changed
- Existing evidence supplemented: No existing source video contains the missing production requirement.
...
- Frame-reextraction recoveries are already represented in `data/phase-zero/cf27_frame_reextractions.json`.
